...
// node_modules/_@tarojs_plugin-platform-weapp@4.0.5@@tarojs/plugin-platform-weapp/dist/runtime.js
...
function initNativeApi(taro) {
    (0,_chunk_FL677IEZ_js__WEBPACK_IMPORTED_MODULE_0__.processApis)(taro, wx, {
        needPromiseApis,
        modifyApis (apis) {
...
var hostConfig = {
    ...
    transferHydrateData (data, element, componentsAlias) {
        ...
        if (element.isTransferElement) {
            ...
            page.setData({
                [(0,_chunk_FL677IEZ_js__WEBPACK_IMPORTED_MODULE_0__.toCamelCase)(data.nn)]: data
            });
            return {
                sid: element.sid,
                ["v"]: "",
...
(0,_chunk_FL677IEZ_js__WEBPACK_IMPORTED_MODULE_0__.mergeReconciler)(hostConfig);
(0,_chunk_FL677IEZ_js__WEBPACK_IMPORTED_MODULE_0__.mergeInternalComponents)(components);
